...
<head>
    ...
    <title>Projects | IIT Bombay</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a href="ppa/index.php" target = "_blank">Apply Now</a> <!-- "apply.php" -->
                    </li>
                    <!--<li>
                        <a href="">Results</a>
                    </li>-->
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <div class="intro-heading">Project Allocation Portal</div>
        ...
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-4">
                    ...
                    <p class="text-muted">All students are supposed to fill the form after clicking the Apply button. </p>
                </div>
                <div class="col-md-4">
                    <span class="fa-stack fa-4x">
                        <i class="fa fa-circle fa-stack-2x text-primary"></i>
               ...
               <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <ul class="list-inline social-buttons">
                            ...
                            <li><a target="_blank" href="https://www.facebook.com/unknownnihar"><i class="fa fa-facebook"></i></a>
                            </li>
                    ...
                    <div class="team-member">
                        ...
                        <ul class="list-inline social-buttons">
                            ...
                            <li><a target="_blank" href="https://www.facebook.com/sakshay.bhatia.9"><i class="fa fa-facebook"></i></a>
                            </li>
                ...
                <div class="col-sm-4">
                    <div class="team-member">
                        ...
                        <ul class="list-inline social-buttons">
                            ...
                            <li><a target="_blank" href="https://www.facebook.com/manasagg1997"><i class="fa fa-facebook"></i></a>
                            </li>
                    ...
                    <div class="team-member">
                        ...
                        <ul class="list-inline social-buttons">
                            ...
                            <li><a target="_blank" href="https://www.facebook.com/sahil.bhargava.71"><i class="fa fa-facebook"></i></a>
                            </li>
