    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="index.php">Project Allocation Portal</a>
            </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <h4 style="color: #ffffff;" class="service-heading">Q. Question 1 </h4>
                    <p style="color: #ffffff;" class="text-muted">Answer 1 </p><p style="color: #ffffff;">Details:<ol style="color: #ffffff;">
                    </ol></p>
...
if(!$mail->send()) {
    ...
    include('connect.php');
    $query = "INSERT INTO project_faq (name, question, email) VALUES ('$name', '$message', '$email')";
