            ...
            <table class="table">
                <tr>
                    ...
                    <td>
                        ...
                        {
                            echo "<input type='text' name='project_name' value='".$cproject_info['project_name']."' readonly/>";
                        }
                        else
                        {
                ...
                <tr>
                    ...
                    <td>
                        <?php echo "<input type='text' name='project_name' value='".$project_info['project_name']."'/>";?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo "<input type='text' name='eligibility_criteria' value='".$project_info['eligibility_criteria']."'/>";?>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <?php echo "<textarea cols='30' rows='3' name='project_details'>".$project_info['project_details']."</textarea>";?>
                    </td>
                </tr>
