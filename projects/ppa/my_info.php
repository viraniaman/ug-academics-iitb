...
{
    $query = "UPDATE student_project_details SET cpi='".$_POST['cpi']."', year_of_study='".$_POST['year_of_study']."', contact_number='".$_POST['contact_number']."' WHERE ldap_id='".$_SESSION['ldap_id']."'";
