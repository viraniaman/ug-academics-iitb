...
$sql = "SELECT * FROM student_project_applications WHERE ldap_id='" . $ldap_id . "'";
...
if (mysqli_num_rows($result) > 1) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        ...
        if ($row['student_answer'] == 'Accepted') {
            $query2 = "DELETE FROM student_project_applications WHERE ldap_id='$ldap_id' AND NOT project_name='" . $row['project_name'] . "'";
            if (!mysqli_query($conn, $query2)) {
                echo "Some problem with deleting the rest of the entries after getting selected in one. "
                . "Contact Anay Tripathi at 8879049043.";
            }
        }
        /*
    ...
    <body>
        ...
        <div class='container'>
            ...
            <table class="table table-striped table-bordered table-hover table-condensed">
                ...
                <?php
                $sql = "SELECT * FROM student_project_applications WHERE ldap_id='" . $ldap_id ."' "
                        . "AND NOT student_answer='Selected for some other project'";
                ...
                if (mysqli_num_rows($result) > 0) {
                    ...
                    <tr>
                        ...
                        . "<td><form action='apply.php' method='post'><input class='btn mini blue-stripe' type='submit' name='" . $row['project_name'] . "' value='Go to projects page'></input>
                    <input type='hidden' name='deadline' value='" . $row2['deadline'] . "' /></form></td>
                   </tr>";
                            }
                        } else {
