...
$query_prof_details = "SELECT * FROM project_info WHERE prof_ldap='".$_SESSION['ldap_id']."'";
...
$_SESSION['project_name'] = $prof_details['project_name'];
...
if(isset($_POST['update_student_project_applications']))
{
...
//    print_r($_POST);
    ...
    {        
        if(preg_match("/^message_to_student/", $key))
        {
            ...
            $query = "UPDATE student_project_applications SET message_to_student='".mysqli_real_escape_string($conn, $value)."' "
                    . "WHERE ldap_id='$student_ldap' AND project_name='".$prof_details['project_name']."'";
...
//                }
            ...
            $query = "UPDATE student_project_applications SET status_of_application='".$value."',"
                    . " waitlist_no='".$_POST['waitlist_no_'.$student_ldap]."'"
                . " WHERE ldap_id='".$student_ldap."' AND project_name='".$_SESSION['project_name']."'";
...
//                echo "not able to set status for $student_ldap <br>";
                $student_status_set = "Not able to set status! Contact Anay Tripathi at 8879049043 or Aman Virani at 9821212128";
            }
        }
        ...
        if(preg_match("/^waitlist_no/", $key))
        {
            ...
            {
                $query = "UPDATE student_project_applications SET waitlist_no='".$value."'"
                . "WHERE ldap_id='".$student_ldap."' AND project_name='".$_SESSION['project_name']."'";
                ...
                {
                    $student_status_set = "Not able to set waitlist! Contact Anay Tripathi at 8879049043";
                }
            }
...
//                    });
//                });
                $("input[name='update_student_project_applications']").click(function()
                {
                    var nos = [];
    ...
    <body>
        ...
        <div class="container">
            ...
            if(!course_is_set())
            {
                echo "<p style='color:red;'><a href='edit_project_info.php'>Please set your project details first!</a></p><br>"
                . "Details of students who have applied for your project will show in the table below. Then you can read their"
            ...
            <form action="faculty.php" method="post">
                ...
                <input type="submit" name="update_student_project_applications" value="Update Table" style="float:right"/><br/><br/>
            ...
            <table class="table sortable" >
                ...
                <tr>
                    ...
                    <th>Year of study</th>
                    <th>CPI</th>
                  <!--  <th>Grade in ?> use echo after php </th> -->
                ...
                $query = "SELECT * FROM student_project_applications WHERE project_name='".$_SESSION['project_name']."'";
                $result = mysqli_query($conn, $query);
                if(mysqli_num_rows($result)>0)
                {
                    while($row = mysqli_fetch_assoc($result))
                    {
                        ...
                        $query_student_info = "SELECT * FROM student_project_details WHERE ldap_id='".$row['ldap_id']."'";
...
//                        print_r($row);
                ...
                {
                    if($_SESSION['project_name']=="" || $_SESSION['project_name']==NULL)
                    {
                        echo "Please set your project info first.";
                    }
                }
