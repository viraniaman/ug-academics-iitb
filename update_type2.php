...
mysql_query("INSERT INTO projects_custom_2014(department,prof_name, interests, eligibility_criteria, duration) 
VALUES('$department','$prof_name','$interests', '$eligibility_criteria', '$duration')") or die (mysql_error());
...
<body id="body1">
    ...
    <div class="container-fluid">
		 ...
		 <p>type2. This page is for projects without specific work.
...
value="treelabs">Treelabs(Inter-Departmental)</option></select>
			  <br>
			  Interests:<br>
				<textarea name="interests" rows="4" columns="0" style="width:750px"></textarea>
				<br>
