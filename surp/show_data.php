...
department=$(this).val();
url="http://gymkhana.iitb.ac.in/~ugacademics/ug_acads/ispa/show_data.php?dep="+department;
window.location=url;
});
});
</script>
...
$query="SELECT * FROM user_data_2013 WHERE department='$department'";
...
$pref1=mysql_query("SELECT prof_name,project_title FROM projects_2013 WHERE id='$p1'");
$pref2=mysql_query("SELECT prof_name,project_title FROM projects_2013 WHERE id='$p2'");
$pref3=mysql_query("SELECT prof_name,project_title FROM projects_2013 WHERE id='$p3'");
