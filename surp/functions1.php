...
function is_registered($ldap_id){
	...
	$query = "SELECT username FROM surp_registered WHERE username='$ldap_id'";
	$result= mysql_query($query);
	$is_registered = mysql_num_rows($result);
...
function register_user($username,$fullname,$roll,$department,$email,$alt_email,$year_of_study,$mobile,$room,$cpi,$experience)
{
	...
	*/
	...
	$query = "INSERT INTO surp_registered (username,roll,fullname,department,email,alt_email,year_of_study,mobile,room,cpi,first_year_exp) VALUES ('$username','$roll','$fullname','$department','$email','$alt_email','$year_of_study','$mobile','$room','$cpi','$experience')";
