...
<div style="width:500px;margin-top:40px;background-color:#696969;font-size:20px;padding:20px;border-radius:10px;box-shadow:8px 8px 8px;">
<p style='color:white;font-size:23px'>Leave your feedback <a href="http://docs.google.com/spreadsheet/viewform?formkey=dGIyenhlSVQ3Q18tNnRvOWNteEM2TlE6MA" style="color:#D1CDCE;"><u>here</u></a></p>
</div>
</center>
</body>
</html>
  ...
  <div class="col-lg-3" style='background-color:black;opacity:0.8;margin-top:30px;color:white;font-size:20px;font-family:verdana;border-radius:10px;border:10px solid #0B2161'>
	<p style='color:white;font-size:25px'>Useful Links:<br></p>
	<ul style="color:black">
	<li>
	<a style="color:#F2F2F2" href='http://gymkhana.iitb.ac.in/~ugacademics'>
	UG Academics</a>
	</li>
	<li>
	<a style="color:#F2F2F2" href='http://gymkhana.iitb.ac.in/~ugacademics/career/'>
	Career Cell</a>
	</li>
	<li>
	<a style="color:#F2F2F2" href='http://gymkhana.iitb.ac.in/~ugacademics/ug_acads/bookbay/'>
	Book Bay</a>
	</li>
	<li>
	<a style="color:#F2F2F2" href='http://gymkhana.iitb.ac.in/~researchbook/'>
	Research Book</a>
	</li>
