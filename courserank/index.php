...
<html>
    ...
    <body>
        ...
        <!--Rainbow band-->
         ...
         <div id="fmenu2" style="margin-right: 70%">
                ...
                <h4>Please note:</h4>
                <ol>
                  <li><b>Disclaimer</b>: Course feedbacks on CourseRank per course are very few in number as compared to the then strength of the class and do not present a wholesome information</li>
                  <li>The feedbacks may vary with change in instructors</li>
                  <li>Students are advised to use the feedbacks on this portal for knowing the course structure and other related details and decide accordingly</li>
                  <li>Please add feedbacks of only those courses which you have completed</li>
                </ol>
                </div>
