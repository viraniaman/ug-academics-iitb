...
mysql_query("INSERT INTO user_data_2013(ldap_id,preference1,preference2,preference3, preference4) VALUES('$username','$preference_1','$preference_2','$preference_3', '$preference_4')") or die (mysql_error());
...
mysql_query("UPDATE user_data_2013 SET preference1='$preference_1',preference2='$preference_2',preference3='$preference_3', preference4='$preference_4' WHERE ldap_id='$username'");
