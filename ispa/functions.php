...
$db = mysql_connect("localhost", "ugacademics", "ug_acads") or die("Connection Error: " . mysql_error());
        ...
        $query = "SELECT ldap_id FROM user_data_2013 WHERE ldap_id='$ldap_id'";
...
function register_user($username,$fullname,$department,$email,$alt_email,$year_of_study,$mobile,$hostel,$room,$sop,$resume)
{
	...
	*/
	...
	$query = "INSERT INTO registered_users_for_project (username,fullname,department,email,alt_email,year_of_study,mobile,hostel,room,sop,resume) VALUES ('$username','$fullname','$department','$email','$alt_email','$year_of_study','$mobile','$hostel','$room','$sop','$resume')";
	$result= mysql_query($query);
